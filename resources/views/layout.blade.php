                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('home') }}" aria-expanded="false">
                                ...
                                <span class="hide-menu">ONG COOPI</span>
                            </a>
                        </li>
                        <Br>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" style="">
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.annee') }}"
                                        aria-expanded="false">
                                        <span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.banque') }}"
                                        aria-expanded="false">
                                        <span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.base') }}"
                                        aria-expanded="false">
                                        <span>
                                            <i class="ti ti-alert-circle"></i>
                                        </span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.typedossier') }}"
                                        aria-expanded="false">
                                        <span>
                                            <i class="ti ti-alert-circle"></i>
                                        </span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.statutmatrimonial') }}"
                                        aria-expanded="false">
                                        <span>
                                            <i class="ti ti-alert-circle"></i>
                                        </span>
                                ...
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.fonction') }}"
                                        aria-expanded="false">
                                        <span>
                                            <i class="ti ti-cards"></i>
                                        </span>
                                        <span class="hide-menu">Fonction</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.sexe') }}">
                                        <span>
                                            <i class="ti ti-file-description"></i>
                                        </span>
                                        <span class="hide-menu">Sexe</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.type_fonction') }}">
                                        <span>
                                            <i class="ti ti-typography"></i>
                                        </span>
                                        <span class="hide-menu">Type Fonction</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link" href="{{ route('configuration.type_contrat') }}">
                                        <span>
                                            <i class="ti ti-typography"></i>
                                        </span>
                                        <span class="hide-menu">Type Contrat</span>
                                    </a>
                                </li>
                            </div>
                            <li class="nav-small-cap">
        ...
        <div class="body-wrapper">
                    ...
                    <div class="navbar-collapse justify-content-end px-0" id="navbarNav">
                        <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                            <a href="https://adminmart.com/product/modernize-free-bootstrap-admin-dashboard/"
                                target="_blank" class="btn btn-primary">COOPI NIGER</a>
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="/vendors/images/profile/user-1.jpg" alt="" width="35"
            ...
            <div class="container-fluid" style="max-width: 98%;margin: 0;">
                ...
                @if (session('notification'))
                    <div class="alert alert-{{ session('notification')['type'] }} alert-dismissible fade show"
                        role="alert">
